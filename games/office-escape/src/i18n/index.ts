export const en = {
  ...
  briefRolling: "Weave through three dispatch lanes on rolling carts and loose boxes. Orange furniture moves: use Grab / drop to bring it closer. Collect both cards.",
  ...
  desktop: 'Keyboard + mouse or touch controls · Sound on for office ambience', furniturePath: 'Yes, the furniture is the path.', hr: 'HR would like a word.',
  ...
  dragging: 'Dragging {object} · Grab / drop to release · stay close to the edge', nearby: 'Grab / drop · Drag {object} — orange furniture can move',
  openOffice: 'Open office', meetings: 'Meeting rooms', coffee: 'Coffee break', final: 'The last stretch',
  hintOffice: 'Follow the mint markers. Jump to leap; hold it near a ledge to mantle.',
  hintMeetings: 'Sprint for the gaps. The orange furniture rolls. Grab / drop to drag it closer.',
  hintCoffee: 'Keep your balance. Carts slide, boxes tip. Checkpoint returns you here.',
...
export const sk: Record<TextKey, string> = {
  ...
  briefRolling: "Prekľučkuj tromi expedičnými uličkami po vozíkoch a škatuliach. Oranžový nábytok sa hýbe: tlačidlom Chytiť / pustiť ho pritiahneš. Zober obe karty.",
  ...
  desktop: 'Klávesnica a myš alebo dotykové ovládanie · So zvukom ožije aj kancelária', furniturePath: 'Áno, cesta vedie po nábytku.', hr: 'Personálne si ťa zavolá.',
  ...
  dragging: 'Ťaháš {object} · Chytiť / pustiť na pustenie · drž sa pri okraji', nearby: 'Chytiť / pustiť · Potiahni {object} — oranžový nábytok sa dá posúvať',
  openOffice: 'Otvorená kancelária', meetings: 'Zasadačky', coffee: 'Prestávka na kávu', final: 'Posledný úsek',
  hintOffice: 'Sleduj zelené značky. Tlačidlom Skok skočíš; podrž ho pri hrane a vylezieš hore.',
  hintMeetings: 'Väčšie medzery preskoč so šprintom. Oranžový nábytok sa hýbe. Tlačidlom Chytiť / pustiť ho pritiahneš.',
  hintCoffee: 'Udrž rovnováhu. Vozíky sa kĺžu, škatule sa prevracajú. Návrat ťa vráti na záchytný bod.',
