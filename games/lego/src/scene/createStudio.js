...
import { createBrickResources, roundedBody } from './brickResources.js'
...
export function createStudio(
  ...
  const brickResources = createBrickResources()
  const { geometry, material, hasType } = brickResources
  ...
  function updateHover() {
    ...
    if (!selection || !hasType(selection.type)) return
