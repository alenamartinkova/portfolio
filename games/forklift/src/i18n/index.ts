export const en = {
  ...
  hintNight: "F toggles the work light. Follow the right aisle to the glowing Bay B.",
  ...
  hintShelfRaise: "Brake before the rack. E raises the pallet above the marked deck; G levels the forks. Move forward slowly.",
  hintShelfLower: "Q lowers the pallet onto the shelf. Leave the forks in the pallet openings, then reverse clear.",
...
export const sk: Record<TextKey, string> = {
  ...
  hintNight: "F prepína pracovné svetlo. Pravou uličkou prejdi k svietiacej zóne B.",
  ...
  hintShelfRaise: "Zabrzdi pred regálom. E zdvihne paletu nad označenú policu, G vyrovná vidlice. Pomaly vojdi dnu.",
  hintShelfLower: "Q spustí paletu na policu. Vidlice nechaj v otvoroch palety a opatrne vycúvaj.",
  levelParcels: "Balíky",
  shelf: "REGÁL",
