...
source tree in `games/hexhaven/src/`. Root pnpm commands validate both projects;
...
under `games/hexhaven/docs/screenshots/`; README records methodology and hardware
...
`games/hexhaven/docs/screenshots/`. No deviations from this follow-up plan.
