export default {
  ...
  games: {
    ...
    meta: {
      ...
      description: 'Hry na chvíľu oddychu: Office Escape, Forklift Certified, Brick Break, Hexhaven a Deploy Friday. Vyberte si dobrodružstvo v prehliadači.',
    },
    ...
    'deploy-friday': {
      ...
      description: 'Udržte produkciu nažive do polnoci. Stavajte pody, cachujte traffic a zastavte retry storm. Sedem vĺn, jeden cloud budget a na Slacku už nikto neodpovedá.',
    },
    'office-escape': {
